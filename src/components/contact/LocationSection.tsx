  ...
  return (
    <section className="relative h-[600px] w-full border-t border-slate-200 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center p-4">
        <div className="bg-white/95 backdrop-blur-xl border border-white/40 p-10 md:p-12 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] text-center max-w-md pointer-events-auto transition-transform hover:-translate-y-2 duration-500">
           <h2 className="text-3xl font-bold text-[#0F172A] mb-4">Visit Us</h2>
           ...
           <a
             ...
             target="_blank"
             rel="noreferrer"
             className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#0F172A] text-white text-sm font-bold rounded-xl hover:bg-primary transition-colors duration-300 shadow-md w-full justify-center"
           >
             Get Directions
           </a>
        </div>
